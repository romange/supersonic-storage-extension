...
class DataValidator {
 public:
  ...
  // generator.
  virtual void Validate(size_t row_count, VariantConstPointer ptr) = 0;
...
class DataGenerator {
 public:
  ...
  virtual VariantConstPointer Generate(size_t row_count) = 0;
...
class BasicTypeValidator : public DataValidator {
 public:
  ...
  void Validate(size_t row_count, VariantConstPointer ptr) {
...
class BasicTypeGenerator : public DataGenerator {
 public:
  ...
  VariantConstPointer Generate(size_t row_count) {
 ...
 public:
  ...
  void Validate(const View& view) {
    ...
    for (int i = 0; i < schema_.attribute_count(); i++) {
      ...
      validators_[2 * i]->Validate(row_count, data);
      if (attribute.is_nullable()) {
        VariantConstPointer is_null =
            VariantConstPointer(view.column(i).is_null());
        validators_[2 * i + 1]->Validate(row_count, is_null);
      }
    }
  }
...
class Generator {
 public:
  ...
  const View& Generate(size_t row_count) {
    for (int i = 0; i < schema_.attribute_count(); i++) {
